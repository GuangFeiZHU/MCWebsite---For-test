class MyPagination():
    def __init__(self,current_page,data_sum,base_url,per_page,per_page_num=11):
        """
    ...
    def pager(self):
        ...
        if self.current_page <= 1:
            ...
            prev = '<li><a href="%s?page=%s" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>' % (self.base_url, self.current_page - 1,)
        ...
        if self.current_page >=self.total_page_num:
            ...
            nex = '<li><a href="%s?page=%s" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>' % (self.base_url, self.current_page + 1,)
